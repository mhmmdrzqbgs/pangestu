...
<div id="profileModal" class="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center hidden">
    <div class="bg-white p-6 rounded-lg shadow-md w-96 text-center">
        ...
        <p><strong>Nama:</strong> <span id="modalNama">Loading...</span></p>
    ...
    <div id="sideNav" class="lg:block hidden bg-white w-64 h-screen fixed border-none overflow-y-auto top-14">
        <div class="p-2 flex flex-col items-center">
            ...
            <div class="w-full space-y-2 mt-5">
                <a href="../guru/index.php" class="px-2 py-2 flex items-center space-x-2 rounded-md text-gray-500 group w-full hover:bg-gray-200">
                    <i class="fas fa-home"></i>
                    <span>Beranda</span>
                </a>
                <a href="../guru/data.php" class="px-2 py-2 flex items-center space-x-2 rounded-md text-gray-500 group w-full hover:bg-gray-200">
                    <i class="fas fa-users"></i>
                    <span>Data Nilai Siswa</span>
                </a>
                <a href="../guru/rekomendasi.php" class="px-2 py-2 flex items-center space-x-2 rounded-md text-gray-500 group w-full hover:bg-gray-200">
                    <i class="fas fa-lightbulb"></i>
                    <span>Rekomendasi Belajar</span>
                </a>
                <a href="../guru/catatan.php" class="px-2 py-2 flex items-center space-x-2 rounded-md text-gray-500 group w-full hover:bg-gray-200">
                    <i class="fas fa-book"></i>
                    <span>Catatan Guru</span>
                </a>
                <a href="../guru/statistik.php" class="px-2 py-2 flex items-center space-x-2 rounded-md text-gray-500 group w-full hover:bg-gray-200">
